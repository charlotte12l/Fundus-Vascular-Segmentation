function centerl=ccenterline(orinimg,a)
%可变参数的中心线检测算法
greenimg=orinimg(:,:,2);
...
canseed4=candidate4;
canseed4(find(canseed4<canmean4+canstd4*a))=0;
canseed4(find(canseed4>canmean4+canstd4*a))=1;
...
canseed3=candidate3;
canseed3(find(canseed3<canmean3+canstd3*a))=0;
canseed3(find(canseed3>canmean3+canstd3*a))=1;
...
canseed2=candidate2;
canseed2(find(canseed2<canmean2+canstd2*a))=0;
canseed2(find(canseed2>canmean2+canstd2*a))=1;
...
canseed1=candidate1;
canseed1(find(canseed1<canmean1+canstd1*a))=0;
canseed1(find(canseed1>canmean1+canstd1*a))=1;
